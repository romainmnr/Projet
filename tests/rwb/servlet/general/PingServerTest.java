...
import rwb.servlet.machine.PreviewStateMachine;
...
public class PingServerTest {
	...
	public void serviceTest()
		...
		Method method = pingServer.getClass().getDeclaredMethod("service", argsTypes);
		method.invoke(pingServer, args);

		writer.flush(); // it may not have been flushed yet...
		Assert.assertTrue(
				FileUtils.readFileToString(new File("somefile.txt"), "UTF-8").contains("\"enabled\":true"));
	}
}
