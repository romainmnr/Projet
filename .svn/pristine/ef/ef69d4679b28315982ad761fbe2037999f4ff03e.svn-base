...
public class menuVM {
	...
	/**
	 * Test to open a page web : localhost:8080/Projet/ Check if the title is
	 * correct
	 */
	@Test
	...
	/**
	 * Test to open Remote Web Box Check if the title and url are correct
	 */
	@Test
	...
	/**
	 * Test to select VM Check if the title and url are correct
	 */
	@Test
	...
	/**
	 * Test to change settings of the machine Check if all of changes are
	 * correct
	 */
	@Test
	public void scenario4_changeSettingsMachine() {

		driver.findElement(By.id("config-btn")).click();

		// General
		driver.findElement(By.name("cfg-general-basic-name")).sendKeys("MachineTest2");
