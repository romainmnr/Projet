...
public class TestSidebar {
   ...
   */
	...
	/**
	 * Test if the sidebar exist
	 * Check if the name of the server is correct
	 */
	@Test
	public void scenario3_checkSidebarExist() {
		...
		String text = driver.findElement(By.id("server-sidebar-name")).getText();
		assertEquals(Messages.getString("rwb_sidebar_serveur"), text);
